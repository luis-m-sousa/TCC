...
class PessoalPublicoController extends Controller
{
    public function index (){
        return view('pessoalPublico.create');
    }
    ...
    public function store(Request $request){
        ...
        $simulacao->tipo = "Crédito pessoal consignado público";
    ...
    public function getTaxa($nome)
    {
        ...
        $tipo_taxa = Tipo_taxa::where('id', '3')->first();
