                                    ...
                                    <div class="card-body p-md-5 mx-md-4 text-center">
                                        ...
                                        <div class="row text-center justify-content-center align-items-center">
                                            <div class="table-responsive">
                                                @if (session('success'))
                                                <div class="alert alert-success alert-dismissible fade show session-alert text-black"
                                                ...
                                                <table class="table text-black">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ number_format($simulacao->taxa, 2, ',') }}</td>
                                                            <td>{{ $simulacao->tempo }}</td>
                                                            <td>{{ number_format($simulacao->parcela, 2, ',', '.')}}</td>
                                                            <td>
